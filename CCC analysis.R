...
results <- mult.icc(VA_subset[,c("VA_AUC",
                                 "VA_1.25_contrast_OU", 
                                 "VA_2.5_contrast_OU", 
                                 "VA_100_contrast_OU", 
                                 "VA_slope", "VA_yint"
                                 )], 
                    grpid= VA_subset$patientID)
results
...
VAcorr <- rename(VAcorr, NeurEx_Panel_02 = NeurEx_Panel_02_B, 
                 NeurEx_Panel_03 = NeurEx_Panel_03_B,
                 NeurEx_Panel_04 = NeurEx_Panel_04_B)
