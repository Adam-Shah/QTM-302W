...
2. Download raw data [here](https://platform.who.int/mortality/themes/theme-details/topics/indicator-groups/indicator-group-details/MDB/abortion). When downloading from the WHO, export dataset and select full data.
