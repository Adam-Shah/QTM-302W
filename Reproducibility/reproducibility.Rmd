...
options(
  usethis.full_name = "Adam Shah",
  usethis.description = list(
    `Authors@R` = 'person("Adam", "Shah", email = "adam.shah@emory.edu", role =   c("aut", "cre")',
    License = "Emory University",
...
```{r}
write_dockerfile(maintainer = "Adam Shah") 
